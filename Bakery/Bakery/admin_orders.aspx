<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin_orders.aspx.cs" Inherits="Bakery.admin_orders" %>
                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="4" DataKeyNames="OrderId" DataSourceID="SqlDataSource3" ForeColor="#333333" GridLines="None" Width="956px" AllowPaging="True">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:HyperLinkField DataNavigateUrlFields="OrderId" DataNavigateUrlFormatString="admin_orderDetails.aspx?OrderId={0}" HeaderText="View details" Text="View Detail" />
                                            </Columns>

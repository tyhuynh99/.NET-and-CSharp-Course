        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-center">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item font-weight-semibold d-none d-lg-block">
                        <a href="#">
                            <p class="mb-1 mt-3 font-weight-semibold">Sign out</p>
                        </a>
                    </li>
                </ul>
                    ...
                    <li class="nav-item nav-profile">
                        <a href="#" class="nav-link">
                            ...
                            <div class="profile-image">
                                <img class="img-xs rounded-circle" src="img/face/face12.jpg" alt="profile image" />
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="py-1">
                                                    <img src="img/faces-clipart/pic-2.png" alt="image" />
                                                </td>
                                                <td>Herman Beck 
                                                </td>
                                                <td></td>
                                            ...
                                            <tr>
                                                <td class="py-1">
                                                    <img src="img/faces-clipart/pic-1.png" alt="image" />
                                                </td>
                                                <td>Messsy Adam </td>
                                                <td></td>
                                                <td>$245.30 </td>
